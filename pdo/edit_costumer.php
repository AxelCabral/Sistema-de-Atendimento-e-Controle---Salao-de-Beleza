<?php
    ...
    $stmt = $cos->edit_costumer_info($id, $conn);
    ...
    <main>
        <section class="list-out-form">
            <div class="form-style">
                <form action="confirm_edit_costumer.php" method="post">
                    <?php
                    ...
                    ?>
                        ...
                        <input id="phone" type="text" name="phone_number" value="<?=$info->tel?>" required>

                        <label for="bdate">Data de Nascimento:</label>
                        <input type="date" name="bdate" value="<?=$info->data_nasc?>" required>
