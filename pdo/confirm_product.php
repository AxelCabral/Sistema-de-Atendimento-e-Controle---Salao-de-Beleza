<?php
    ...
    if(isset($_POST['name'], $_POST['quantity'], $_POST['min'])&& $_POST['name'] != "" && $_POST['quantity'] != ""
    && $_POST['min'] != ""){
        ...
        $insert = new product_DAO();
        $result = $insert->insert_product($p, $conn);

        if($result == true){
            $message = "Sucesso! O produto foi registrado com êxito.";
        }
    ...
    <main>
        <section class="list-out-form">
            <div class="form-style">
                <p><?=$message?></p>
                <a href="../new_product.php" target="_self" rel="prev">Registrar outro produto</a>
            </div>
        </section>
    </main>
    <footer>
