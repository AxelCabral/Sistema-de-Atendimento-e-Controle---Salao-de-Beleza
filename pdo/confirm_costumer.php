<?php
    ...
    if(isset($_POST['name'], $_POST['phone_number'], $_POST['bdate'])&& $_POST['name'] != "" &&
    $_POST['phone_number'] != "" && $_POST['bdate'] != ""){
        ...
        $insert = new costumer_DAO();
        $result = $insert->insert_costumer($cos, $conn);

        if($result == true){
            $message = "Sucesso! O cliente foi registrado com êxito.";
        }
    ...
    <main>
        <section class="list-out-form">
            <div class="form-style">
                <p><?=$message?></p>
                <a href="../new_costumer.php" target="_self" rel="prev">Registrar outro cliente</a>
            </div>
        </section>
    </main>
    <footer>
